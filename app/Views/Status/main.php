...
<!-- Modal -->
<div class="modal" id="blankParams" tabindex="-1" aria-labelledby="blankParamsLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="blankParamsLabel">Tidak dapat diproses</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">Parameter tidak boleh kosong.</div>
